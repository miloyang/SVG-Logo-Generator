...
describe('Shape', () => {
    it('does the new instance of Triangle return an svg', () => {
        ...
        expect(triangle.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150, 18 244, 182 56, 182" fill="white" /><text x="150" y="145" font-size="55" text-anchor="middle" fill="blue">CS</text></svg>`)
    });
});
